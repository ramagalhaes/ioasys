...
const Books: React.FC = () => {
  ...
  return (
    ...
    <div className='grid'>
      <header className='header'>
        ...
        <nav className="nav-menu">
          <p>Bem vindo, <b>{userData.name} !</b></p>
          <button className='action-btn' onClick={performSignOut}>X</button>
        </nav>
      </header>
      <main>
        ...
        <div className='page-navigation'>
          <p>Página <b>{currentPage}</b> de <b>{totalPages}</b></p>
          <button 
    ...
    {/* BOOK MODAL */}
    { showModal === true ? <section className='modal-bg'>
        <button className='action-btn close-btn' onClick={closeModal}>X</button>
              ...
              <div className='book-info'>
                ...
                <div className='sinopse-container'>
                  ...
                  <div className='sinopse-text'>
                    <p><img src={Quotes} alt="Aspas" />{book?.description}</p>
                  </div>
                </div>
              </div>
            </div>
